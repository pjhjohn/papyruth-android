 ...
 */
public class ProfessorGridItemView extends UniversalItemView<ProfessorGridItemView.Holder, ProfessorGridItemView.Data> {
    public ProfessorGridItemView (Data data) {
        super(data);
