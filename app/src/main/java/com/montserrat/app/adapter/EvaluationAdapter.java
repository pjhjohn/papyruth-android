...
public class EvaluationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected class EvaluationViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Evaluation evaluation) {
            ...
            this.timestamp.setText(evaluation.getCreatedAt());
            ...
            Picasso.with(this.itemView.getContext()).load(R.drawable.avatar_dummy).transform(new CircleTransformation()).into(this.upIcon);
            this.upCount.setText("7");//TODO : evaluation.getUpVoteCount()
            Picasso.with(this.itemView.getContext()).load(R.drawable.avatar_dummy).transform(new CircleTransformation()).into(this.downIcon);
            ...
            this.commentCount.setText("" + evaluation.getComments().size());//TODO : evaluation.getUpVoteCount()
        }
    }
