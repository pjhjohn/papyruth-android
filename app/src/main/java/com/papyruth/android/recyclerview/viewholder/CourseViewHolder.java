...
public class CourseViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    @BindView(R.id.course_professor_image)                protected ImageView mProfessorImage;
    @BindView(R.id.course_lecture)                        protected TextView mLecture;
    @BindView(R.id.course_favorite)                       protected ImageView mFavorite;
    @BindView(R.id.course_category)                       protected TextView mCategory;
    @BindView(R.id.course_professor)                      protected TextView mProfessor;
    @BindView(R.id.course_overall_label)                  protected TextView mLabelOverall;
    @BindView(R.id.course_overall_ratingbar)              protected RatingBar mRatingBarOverall;
    @BindView(R.id.course_overall_point)                  protected TextView mPointOverall;
    @BindView(R.id.course_clarity_label)                  protected TextView mLabelClarity;
    @BindView(R.id.course_clarity_progressbar)            protected ProgressBar mProgressBarClarity;
    @BindView(R.id.course_clarity_point)                  protected TextView mPointClarity;
    @BindView(R.id.course_easiness_label)                 protected TextView mLabelEasiness;
    @BindView(R.id.course_easiness_progressbar)           protected ProgressBar mProgressBarEasiness;
    @BindView(R.id.course_easiness_point)                 protected TextView mPointEasiness;
    @BindView(R.id.course_gpa_satisfaction_label)         protected TextView mLabelGpaSatisfaction;
    @BindView(R.id.course_gpa_satisfaction_progressbar)   protected ProgressBar mProgressBarGpaSatisfaction;
    @BindView(R.id.course_gpa_satisfaction_point)         protected TextView mPointGpaSatisfaction;
    @BindView(R.id.course_hashtags)                       protected TextView mHashtags;
    @BindView(R.id.course_statistics)                     protected LinearLayout mStatistics;
    @BindView(R.id.course_evaluation_icon)                protected ImageView mEvaluationIcon;
    @BindView(R.id.course_evaluation_count)               protected TextView mEvaluationCount;
    @BindView(R.id.course_no_evaluations_message)         protected LinearLayout mNoEvaluationsMessage;
